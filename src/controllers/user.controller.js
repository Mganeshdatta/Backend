...
const registerUser = asyncHandler( async (req,res)=>{
    ...
    // check for images, cheack for avator
    // upload them to cloudinary, avator
    // create user object - create an db
...
const loginUser = asyncHandler( async (req,res)=>{
    ...
    //if exist compare password using bcrypt.compare()
    //if password is correct allocate accesstoken and refresh token
...
const updataAccountDetails = asyncHandler( async () => {
